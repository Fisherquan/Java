...
public class EditCarDialog extends JDialog {
    ...
    public EditCarDialog(JFrame parent, String id, String brand, String model, String year, String price, String status) {
        super(parent, "Edit Car - " + id, true);
        ...
        priceField = new JTextField(price.replace("$", ""));
